...
export default function HistoryPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      // Fetch all FeePaid events from contract deployment
      const logs = await publicClient.getLogs({
        ...
        fromBlock: 0x9fc019, // Contract deployment block
        toBlock:   'latest',
      });
 
      // Filter by student ID client-side (studentId is not indexed)
      const filtered = logs
